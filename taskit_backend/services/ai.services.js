            ...
            const response = await axios.post(
                'https://openrouter.ai/api/v1/chat/completions',
                {
                    ...
                    messages: [
                        ...
                        { role: 'user', content: `Give me a list of 5 suitable categories for the task with title: ${title}. Answer only in JSON format, where the response is in this format: {"categories": ["category1", "category2", "category3", "category4", "category5"]}. No special symbols, no extra text.` }
                    ],
                },
                {
                    headers: {
