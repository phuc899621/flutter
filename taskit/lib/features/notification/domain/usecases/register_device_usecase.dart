...
class RegisterDeviceUseCase extends FutureUseCase<void, String> {
  ...
  Future<Result<void, Failure>> call(String params) =>
      runSafe(() => _repo.registerDevice(params));
}

final registerDeviceUseCaseProvider = Provider<RegisterDeviceUseCase>(
  (ref) => RegisterDeviceUseCase(ref.watch(firebaseMessagingRepoProvider)),
);
