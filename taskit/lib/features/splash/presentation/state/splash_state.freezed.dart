...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SplashState&&(identical(other.isLoginExpired, isLoginExpired) || other.isLoginExpired == isLoginExpired));
}
...
/// Create a copy of SplashState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoginExpired = freezed,}) {
  return _then(_self.copyWith(
isLoginExpired: freezed == isLoginExpired ? _self.isLoginExpired : isLoginExpired // ignore: cast_nullable_to_non_nullable
as bool?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool? isLoginExpired)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SplashState() when $default != null:
return $default(_that.isLoginExpired);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool? isLoginExpired)  $default,) {final _that = this;
switch (_that) {
case _SplashState():
return $default(_that.isLoginExpired);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool? isLoginExpired)?  $default,) {final _that = this;
switch (_that) {
case _SplashState() when $default != null:
return $default(_that.isLoginExpired);case _:
  return null;
...
@override final  bool? isLoginExpired;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SplashState&&(identical(other.isLoginExpired, isLoginExpired) || other.isLoginExpired == isLoginExpired));
}
...
/// Create a copy of SplashState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoginExpired = freezed,}) {
