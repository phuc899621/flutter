    ...
    return GestureDetector(
     ...
     child: Scaffold(
      ...
      floatingActionButton: isKeyboardVisible?null: FloatingActionButton.extended(
          ...
          icon: Icon(Icons.save,color: AppColor(context).onPrimary,
          )
      ),
      appBar: AppBar(
        title: Column(
        ...
        child: SingleChildScrollView(
          ...
          child: Container(
                  ...
                  minLines: 5,
                      ...
                      SizedBox(height: 10,),
                      DueDateButton(
                          initialDate: state.selectedDate?? DateTime(
                            DateTime.now().year,
                            DateTime.now().month,
                            DateTime.now().day,
                            0,
                            ...
                            controller.updateSelectedDate(
                                year, month, day, state.selectedDate!.hour, state.selectedDate!.minute
                            );
                      ...
                      TextButton.icon(
                        ...
                        icon: Icon(Icons.add,color: AppColor(context).secondaryText,),
                      ),
                      SizedBox(height: 200),
