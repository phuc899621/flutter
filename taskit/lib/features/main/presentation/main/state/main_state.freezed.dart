...
mixin _$MainState {
 ...
 String? get generateTaskText; String? get error;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MainState&&(identical(other.generateTaskText, generateTaskText) || other.generateTaskText == generateTaskText)&&(identical(other.error, error) || other.error == error));
}
...
@useResult
$Res call({
 String? generateTaskText, String? error
});
...
/// Create a copy of MainState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? generateTaskText = freezed,Object? error = freezed,}) {
  return _then(_self.copyWith(
generateTaskText: freezed == generateTaskText ? _self.generateTaskText : generateTaskText // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? generateTaskText,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MainState() when $default != null:
return $default(_that.generateTaskText,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? generateTaskText,  String? error)  $default,) {final _that = this;
switch (_that) {
case _MainState():
return $default(_that.generateTaskText,_that.error);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? generateTaskText,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _MainState() when $default != null:
return $default(_that.generateTaskText,_that.error);case _:
  return null;
...
@override final  String? generateTaskText;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MainState&&(identical(other.generateTaskText, generateTaskText) || other.generateTaskText == generateTaskText)&&(identical(other.error, error) || other.error == error));
}
...
/// Create a copy of MainState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? generateTaskText = freezed,Object? error = freezed,}) {
