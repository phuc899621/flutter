...
class _TaskApi implements TaskApi {
  ...
  Future<BaseResponse<TaskDataLst>> getListTask(
    ...
    final _options = _setStreamType<BaseResponse<TaskDataLst>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<BaseResponse<CategoryData>> suggestCategory(
    String token,
    SuggestCategoryReq suggestCategoryReq,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    final _data = suggestCategoryReq;
    final _options = _setStreamType<BaseResponse<CategoryData>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<CategoryData> _value;
    try {
      _value = BaseResponse<CategoryData>.fromJson(
        _result.data!,
        (json) => CategoryData.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
