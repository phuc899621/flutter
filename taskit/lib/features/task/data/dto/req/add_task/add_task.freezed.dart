...
mixin _$AddTaskReq {
 ...
 String get title; int get localId; String get description; String get categoryId; String get priority; DateTime? get dueDate; bool get hasTime; String get status; List<AddSubtaskReq> get subtasks;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,localId,description,categoryId,priority,dueDate,hasTime,status,const DeepCollectionEquality().hash(subtasks));
...
@useResult
$Res call({
 String title, int localId, String description, String categoryId, String priority, DateTime? dueDate, bool hasTime, String status, List<AddSubtaskReq> subtasks
});
...
/// Create a copy of AddTaskReq
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? localId = null,Object? description = null,Object? categoryId = null,Object? priority = null,Object? dueDate = freezed,Object? hasTime = null,Object? status = null,Object? subtasks = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  int localId,  String description,  String categoryId,  String priority,  DateTime? dueDate,  bool hasTime,  String status,  List<AddSubtaskReq> subtasks)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AddTaskReq() when $default != null:
return $default(_that.title,_that.localId,_that.description,_that.categoryId,_that.priority,_that.dueDate,_that.hasTime,_that.status,_that.subtasks);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  int localId,  String description,  String categoryId,  String priority,  DateTime? dueDate,  bool hasTime,  String status,  List<AddSubtaskReq> subtasks)  $default,) {final _that = this;
switch (_that) {
case _AddTaskReq():
return $default(_that.title,_that.localId,_that.description,_that.categoryId,_that.priority,_that.dueDate,_that.hasTime,_that.status,_that.subtasks);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  int localId,  String description,  String categoryId,  String priority,  DateTime? dueDate,  bool hasTime,  String status,  List<AddSubtaskReq> subtasks)?  $default,) {final _that = this;
switch (_that) {
case _AddTaskReq() when $default != null:
return $default(_that.title,_that.localId,_that.description,_that.categoryId,_that.priority,_that.dueDate,_that.hasTime,_that.status,_that.subtasks);case _:
  return null;
...
class _AddTaskReq implements AddTaskReq {
  const _AddTaskReq({required this.title, required this.localId, required this.description, required this.categoryId, required this.priority, this.dueDate, required this.hasTime, required this.status, required final  List<AddSubtaskReq> subtasks}): _subtasks = subtasks;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,localId,description,categoryId,priority,dueDate,hasTime,status,const DeepCollectionEquality().hash(_subtasks));
...
/// Create a copy of AddTaskReq
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? localId = null,Object? description = null,Object? categoryId = null,Object? priority = null,Object? dueDate = freezed,Object? hasTime = null,Object? status = null,Object? subtasks = null,}) {
