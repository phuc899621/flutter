...
mixin _$CategoryEntity {
 ...
 String get name; int get localId; int get userLocalId;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CategoryEntity&&(identical(other.name, name) || other.name == name)&&(identical(other.localId, localId) || other.localId == localId)&&(identical(other.userLocalId, userLocalId) || other.userLocalId == userLocalId));
}
...
@useResult
$Res call({
 String name, int localId, int userLocalId
});
...
/// Create a copy of CategoryEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? localId = null,Object? userLocalId = null,}) {
  return _then(_self.copyWith(
name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,localId: null == localId ? _self.localId : localId // ignore: cast_nullable_to_non_nullable
as int,userLocalId: null == userLocalId ? _self.userLocalId : userLocalId // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  int localId,  int userLocalId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryEntity() when $default != null:
return $default(_that.name,_that.localId,_that.userLocalId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  int localId,  int userLocalId)  $default,) {final _that = this;
switch (_that) {
case _CategoryEntity():
return $default(_that.name,_that.localId,_that.userLocalId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  int localId,  int userLocalId)?  $default,) {final _that = this;
switch (_that) {
case _CategoryEntity() when $default != null:
return $default(_that.name,_that.localId,_that.userLocalId);case _:
  return null;
...
class _CategoryEntity implements CategoryEntity {
  const _CategoryEntity({required this.name, required this.localId, required this.userLocalId});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CategoryEntity&&(identical(other.name, name) || other.name == name)&&(identical(other.localId, localId) || other.localId == localId)&&(identical(other.userLocalId, userLocalId) || other.userLocalId == userLocalId));
}
...
/// Create a copy of CategoryEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? localId = null,Object? userLocalId = null,}) {
