...
@override
int get hashCode => Object.hashAll([runtimeType,localId,remoteId,title,description,category,priority,userLocalId,synced,deleted,reminderAt,reminderOffset,reminderType,completedAt,status,dueDate,hasTime,const DeepCollectionEquality().hash(subtasks),createdAt,updatedAt]);

@override
String toString() {
  return 'TaskEntity(localId: $localId, remoteId: $remoteId, title: $title, description: $description, category: $category, priority: $priority, userLocalId: $userLocalId, synced: $synced, deleted: $deleted, reminderAt: $reminderAt, reminderOffset: $reminderOffset, reminderType: $reminderType, completedAt: $completedAt, status: $status, dueDate: $dueDate, hasTime: $hasTime, subtasks: $subtasks, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 int localId, String? remoteId, String title, String description, CategoryEntity category, TaskPriority priority, int userLocalId, bool synced, bool deleted, DateTime? reminderAt, int? reminderOffset, TaskReminderType reminderType, DateTime? completedAt, TaskStatus status, DateTime? dueDate, bool hasTime, List<SubtaskEntity> subtasks, DateTime createdAt, DateTime updatedAt
});
...
as TaskReminderType,completedAt: freezed == completedAt ? _self.completedAt : completedAt // ignore: cast_nullable_to_non_nullable
...
@override
int get hashCode => Object.hashAll([runtimeType,localId,remoteId,title,description,category,priority,userLocalId,synced,deleted,reminderAt,reminderOffset,reminderType,completedAt,status,dueDate,hasTime,const DeepCollectionEquality().hash(_subtasks),createdAt,updatedAt]);
