...
mixin _$TaskEntity {
 ...
 int get localId; String get title; String get description; CategoryEntity get category; TaskPriority get priority; int get userLocalId; DateTime? get completedAt; TaskStatus get status; DateTime? get dueDate; bool get hasTime; List<SubtaskEntity> get subtasks; DateTime get createdAt; DateTime get updatedAt;
...
@override
int get hashCode => Object.hash(runtimeType,localId,title,description,category,priority,userLocalId,completedAt,status,dueDate,hasTime,const DeepCollectionEquality().hash(subtasks),createdAt,updatedAt);
...
@useResult
$Res call({
 int localId, String title, String description, CategoryEntity category, TaskPriority priority, int userLocalId, DateTime? completedAt, TaskStatus status, DateTime? dueDate, bool hasTime, List<SubtaskEntity> subtasks, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of TaskEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? localId = null,Object? title = null,Object? description = null,Object? category = null,Object? priority = null,Object? userLocalId = null,Object? completedAt = freezed,Object? status = null,Object? dueDate = freezed,Object? hasTime = null,Object? subtasks = null,Object? createdAt = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int localId,  String title,  String description,  CategoryEntity category,  TaskPriority priority,  int userLocalId,  DateTime? completedAt,  TaskStatus status,  DateTime? dueDate,  bool hasTime,  List<SubtaskEntity> subtasks,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TaskEntity() when $default != null:
return $default(_that.localId,_that.title,_that.description,_that.category,_that.priority,_that.userLocalId,_that.completedAt,_that.status,_that.dueDate,_that.hasTime,_that.subtasks,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int localId,  String title,  String description,  CategoryEntity category,  TaskPriority priority,  int userLocalId,  DateTime? completedAt,  TaskStatus status,  DateTime? dueDate,  bool hasTime,  List<SubtaskEntity> subtasks,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _TaskEntity():
return $default(_that.localId,_that.title,_that.description,_that.category,_that.priority,_that.userLocalId,_that.completedAt,_that.status,_that.dueDate,_that.hasTime,_that.subtasks,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int localId,  String title,  String description,  CategoryEntity category,  TaskPriority priority,  int userLocalId,  DateTime? completedAt,  TaskStatus status,  DateTime? dueDate,  bool hasTime,  List<SubtaskEntity> subtasks,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _TaskEntity() when $default != null:
return $default(_that.localId,_that.title,_that.description,_that.category,_that.priority,_that.userLocalId,_that.completedAt,_that.status,_that.dueDate,_that.hasTime,_that.subtasks,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _TaskEntity implements TaskEntity {
  const _TaskEntity({required this.localId, required this.title, required this.description, required this.category, required this.priority, required this.userLocalId, this.completedAt, required this.status, this.dueDate, required this.hasTime, required final  List<SubtaskEntity> subtasks, required this.createdAt, required this.updatedAt}): _subtasks = subtasks;
...
@override
int get hashCode => Object.hash(runtimeType,localId,title,description,category,priority,userLocalId,completedAt,status,dueDate,hasTime,const DeepCollectionEquality().hash(_subtasks),createdAt,updatedAt);
...
/// Create a copy of TaskEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? localId = null,Object? title = null,Object? description = null,Object? category = null,Object? priority = null,Object? userLocalId = null,Object? completedAt = freezed,Object? status = null,Object? dueDate = freezed,Object? hasTime = null,Object? subtasks = null,Object? createdAt = null,Object? updatedAt = null,}) {
