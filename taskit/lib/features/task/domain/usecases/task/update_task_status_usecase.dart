...
final updateTaskStatusUseCaseProvider = Provider<UpdateTaskStatusUseCase>(
  (ref) => UpdateTaskStatusUseCase(ref.watch(taskRepoProvider)),
);

class UpdateTaskStatusUseCase extends FutureUseCase<void, TaskEntity> {
  final TaskRepo _repo;

  UpdateTaskStatusUseCase(this._repo);

  @override
  Future<Result<void, Failure>> call(TaskEntity params) =>
      runSafe(() => _repo.updateTask(TaskUpdateField.status, params));
}
