...
final updateSubtaskTitleUseCaseProvider = Provider<UpdateSubtaskTitleUseCase>(
  (ref) => UpdateSubtaskTitleUseCase(
    ref.watch(subtaskRepoProvider),
    ref.watch(getCurrentUserUseCaseProvider),
  ),
);

class UpdateSubtaskTitleUseCase extends FutureUseCase<void, SubtaskEntity> {
  final SubtaskRepo _repo;
  final GetCurrentUserUseCase _getCurrentUser;

  UpdateSubtaskTitleUseCase(this._repo, this._getCurrentUser);
