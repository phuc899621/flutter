...
mixin _$AddTaskState {
 ...
 AddTaskStatus get status; String? get apiError; List<CategoryEntity> get categories; List<CategoryEntity> get aiCategories; List<SubtaskEntity> get subtasks; TaskPriority get selectedPriority; TaskReminderType get reminderType; DateTime? get reminderAt; ReminderRepeatType get repeatType; int? get reminderOffset; CategoryEntity? get selectedCategory; DateTime? get selectedDate; Map<String, dynamic> get addTaskForm; bool get isTimeSelected;
...
@override
int get hashCode => Object.hash(runtimeType,status,apiError,const DeepCollectionEquality().hash(categories),const DeepCollectionEquality().hash(aiCategories),const DeepCollectionEquality().hash(subtasks),selectedPriority,reminderType,reminderAt,repeatType,reminderOffset,selectedCategory,selectedDate,const DeepCollectionEquality().hash(addTaskForm),isTimeSelected);

@override
String toString() {
  return 'AddTaskState(status: $status, apiError: $apiError, categories: $categories, aiCategories: $aiCategories, subtasks: $subtasks, selectedPriority: $selectedPriority, reminderType: $reminderType, reminderAt: $reminderAt, repeatType: $repeatType, reminderOffset: $reminderOffset, selectedCategory: $selectedCategory, selectedDate: $selectedDate, addTaskForm: $addTaskForm, isTimeSelected: $isTimeSelected)';
}
...
@useResult
$Res call({
 AddTaskStatus status, String? apiError, List<CategoryEntity> categories, List<CategoryEntity> aiCategories, List<SubtaskEntity> subtasks, TaskPriority selectedPriority, TaskReminderType reminderType, DateTime? reminderAt, ReminderRepeatType repeatType, int? reminderOffset, CategoryEntity? selectedCategory, DateTime? selectedDate, Map<String, dynamic> addTaskForm, bool isTimeSelected
});
...
as ReminderRepeatType,reminderOffset: freezed == reminderOffset ? _self.reminderOffset : reminderOffset // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _AddTaskState() when $default != null:
return $default(_that.status,_that.apiError,_that.categories,_that.aiCategories,_that.subtasks,_that.selectedPriority,_that.reminderType,_that.reminderAt,_that.repeatType,_that.reminderOffset,_that.selectedCategory,_that.selectedDate,_that.addTaskForm,_that.isTimeSelected);case _:
  return orElse();
...
switch (_that) {
case _AddTaskState():
return $default(_that.status,_that.apiError,_that.categories,_that.aiCategories,_that.subtasks,_that.selectedPriority,_that.reminderType,_that.reminderAt,_that.repeatType,_that.reminderOffset,_that.selectedCategory,_that.selectedDate,_that.addTaskForm,_that.isTimeSelected);}
}
...
class _AddTaskState implements AddTaskState {
  const _AddTaskState({this.status = AddTaskStatus.initial, this.apiError, final  List<CategoryEntity> categories = const [], final  List<CategoryEntity> aiCategories = const [], final  List<SubtaskEntity> subtasks = const [], this.selectedPriority = TaskPriority.none, this.reminderType = TaskReminderType.none, this.reminderAt, this.repeatType = ReminderRepeatType.none, this.reminderOffset, this.selectedCategory, this.selectedDate, final  Map<String, dynamic> addTaskForm = const {}, this.isTimeSelected = false}): _categories = categories,_aiCategories = aiCategories,_subtasks = subtasks,_addTaskForm = addTaskForm;
...
@override
int get hashCode => Object.hash(runtimeType,status,apiError,const DeepCollectionEquality().hash(_categories),const DeepCollectionEquality().hash(_aiCategories),const DeepCollectionEquality().hash(_subtasks),selectedPriority,reminderType,reminderAt,repeatType,reminderOffset,selectedCategory,selectedDate,const DeepCollectionEquality().hash(_addTaskForm),isTimeSelected);
