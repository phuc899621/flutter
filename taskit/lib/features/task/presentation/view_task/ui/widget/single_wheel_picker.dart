...
import 'package:taskit/features/task/presentation/view_task/ui/widget/wheel_picker_item.dart';
  ...
  Widget build(BuildContext context) {
    return ListWheelScrollView.useDelegate(
      ...
      childDelegate: ListWheelChildBuilderDelegate(
        ...
        builder: (context, index) => WheelPickerItem(text: widget.items[index]),
      ),
    );
  }
}
