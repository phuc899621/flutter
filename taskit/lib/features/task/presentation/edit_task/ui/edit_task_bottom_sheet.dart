    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        TextFormField(
          ...
          controller:
              titleController.getOrCreateController(initial: task?.title ?? ''),
          decoration: InputDecoration(
              hint: Text(
                'Title',
                style: text.titleLarge?.copyWith(
                    fontWeight: FontWeight.w400, color: color.onSurfaceVariant),
              ),
              counterText: '',
          ...
          onChanged: (value) {
            ...
            ref.read(editTaskControllerProvider.notifier).updateTitle(value);
          },
        ),
        TextFormField(
          maxLines: 2,
          ...
          style: text.bodyMedium
              ?.copyWith(fontWeight: FontWeight.w400, color: color.onSurface),
          onChanged: (value) {
          ...
          child: Row(spacing: 10, children: [
            ...
            MenuAnchor(
              ...
              builder: (context, controller, child) => ActionChip(
                ...
                onPressed: () =>
                    controller.isOpen ? controller.close() : controller.open(),
                avatar: Icon(Icons.category_rounded, color: color.secondary),
                shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(8),
