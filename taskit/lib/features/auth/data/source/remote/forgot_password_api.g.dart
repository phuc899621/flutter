...
class _ForgotPasswordApi implements ForgotPasswordApi {
  ...
  @override
  Future<MessageResponse> forgotPassword(ForgotPassRequest data) async {
  ...
  @override
  Future<MessageResponse> forgotPasswordResend(ForgotPassRequest data) async {
    final _extra = <String, dynamic>{'refresh': false};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = data;
  ...
  @override
  Future<MessageResponse> forgotPasswordReset(ForgotPassRequest data) async {
    final _extra = <String, dynamic>{'refresh': false};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = data;
