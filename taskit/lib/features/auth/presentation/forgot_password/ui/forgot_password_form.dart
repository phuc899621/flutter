...
class ForgotPasswordForm extends ConsumerStatefulWidget{
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>_ForgotPasswordFormState();
}
class _ForgotPasswordFormState extends ConsumerState<ForgotPasswordForm> {
        ...
        children: [
          ...
          Align(
            ...
            child: Padding(
              ...
              child: TaskitElevationButton(onPressed: ()=>_onSummit(),text: 'Send',)
            ),
          ),
        ],
      ),
  ...
  void _listener() {
    ref.listen(forgotPassControllerProvider.select((value) => value.errorForgotPass),
            (_,next){
          if (next != null) {
    ...
    ref.listen(forgotPassControllerProvider.select((value)=>value.isForgotPassSuccess),
            (_,next){
          if (next != null && next) {
