...
class $SubtaskTableTable extends SubtaskTable
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<SubtaskTableData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class SubtaskTableData extends DataClass
  ...
  factory SubtaskTableData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    WritePropagation(
      ...
      result: [TableUpdate('category', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'user',
      ...
      result: [TableUpdate('task', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'task',
      ...
      result: [TableUpdate('subtask', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'user',
      ...
      result: [TableUpdate('setting', kind: UpdateKind.delete)],
    ),
  ]);
}
...
final class $$UserTableTableReferences
  ...
  _categoryTableRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.categoryTable,
    aliasName: $_aliasNameGenerator(
      db.userTable.localId,
      db.categoryTable.userLocalId,
    ),
  );
  ...
  _settingTableRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.settingTable,
    aliasName: $_aliasNameGenerator(
      db.userTable.localId,
      db.settingTable.userLocalId,
    ),
  );
    ...
    extends
        RootTableManager<
          ...
          PrefetchHooks Function({
            bool categoryTableRefs,
            bool taskTableRefs,
            bool settingTableRefs,
          })
        > {
...
final class $$CategoryTableTableReferences
  ...
  _taskTableRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.taskTable,
    aliasName: $_aliasNameGenerator(
      db.categoryTable.localId,
      db.taskTable.categoryLocalId,
    ),
  );
...
final class $$TaskTableTableReferences
  ...
  _subtaskTableRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.subtaskTable,
    aliasName: $_aliasNameGenerator(
      db.taskTable.localId,
      db.subtaskTable.taskLocalId,
    ),
  );
          ...
          prefetchHooksCallback:
              ({
                ...
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (subtaskTableRefs) db.subtaskTable,
                  ],
                  addJoins:
                      <
                        T extends TableManagerState<
...
final class $$SubtaskTableTableReferences
    extends
  ...
  static $TaskTableTable _taskLocalIdTable(_$AppDatabase db) =>
      db.taskTable.createAlias(
        $_aliasNameGenerator(db.subtaskTable.taskLocalId, db.taskTable.localId),
      );
...
class $$SubtaskTableTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $SubtaskTableTable,
                    ...
                    if (taskLocalId) {
                      state =
                          state.withJoin(
                                ...
                                referencedTable: $$SubtaskTableTableReferences
...
typedef $$SubtaskTableTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $SubtaskTableTable,
      SubtaskTableData,
...
final class $$SettingTableTableReferences
    extends
  ...
  static $UserTableTable _userLocalIdTable(_$AppDatabase db) =>
      db.userTable.createAlias(
        $_aliasNameGenerator(db.settingTable.userLocalId, db.userTable.localId),
      );
                    ...
                    if (userLocalId) {
                      state =
                          state.withJoin(
                                currentTable: table,
                                currentColumn: table.userLocalId,
                                referencedTable: $$SettingTableTableReferences
                                    ._userLocalIdTable(db),
