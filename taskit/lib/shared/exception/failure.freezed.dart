...
mixin _$Failure {
 ...
 String get message; int? get statusCode; Object? get exception; StackTrace get stackTrace;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Failure&&(identical(other.message, message) || other.message == message)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&const DeepCollectionEquality().equals(other.exception, exception)&&(identical(other.stackTrace, stackTrace) || other.stackTrace == stackTrace));
}


@override
int get hashCode => Object.hash(runtimeType,message,statusCode,const DeepCollectionEquality().hash(exception),stackTrace);
...
@useResult
$Res call({
 String message, int? statusCode, Object? exception, StackTrace stackTrace
});
...
as int?,exception: freezed == exception ? _self.exception : exception ,stackTrace: null == stackTrace ? _self.stackTrace : stackTrace // ignore: cast_nullable_to_non_nullable
as StackTrace,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String message,  int? statusCode,  Object? exception,  StackTrace stackTrace)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Failure() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String message,  int? statusCode,  Object? exception,  StackTrace stackTrace)  $default,) {final _that = this;
switch (_that) {
case _Failure():
return $default(_that.message,_that.statusCode,_that.exception,_that.stackTrace);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String message,  int? statusCode,  Object? exception,  StackTrace stackTrace)?  $default,) {final _that = this;
switch (_that) {
case _Failure() when $default != null:
return $default(_that.message,_that.statusCode,_that.exception,_that.stackTrace);case _:
  return null;
