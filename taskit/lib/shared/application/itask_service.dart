...
abstract interface class ITaskService{
  ...
  Future<Result<void,Failure>> createTask(String token,CreateTaskReq createTaskReq);
  Future<Result<CategoryModel,Failure>> suggestCategory(String token,SuggestCategoryReq suggestCategoryReq);
